...
import com.mob.jlogstash.tailer.Tailer;
import com.mob.jlogstash.tailer.TailerHelper;
import com.mob.jlogstash.tailer.TailerListener;

/**
 * Test case for tailer class.
 * 
 * @author zxc Jan 8, 2016 4:51:21 PM
 */
public class TailerTest {
    ...
    /**
     * Old file updated, and new file created, and new file is smaller than old file.
     */
    @Test
    public void testOldUpdateAndNew_SmallNewFile() throws Exception {
        ...
        /*
         * old file has been read, pause the tailer, update old file, create the new file and write content to it
         */
        tailer.pause();
    ...
    /**
     * Old file updated, and new file created, and new file is bigger than old file.
     */
    @Test
    ...
    /**
     * Old file updated, and new file created, and new file is equal size with old file.
     */
    @Test
