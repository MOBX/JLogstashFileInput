...
/**
 * @author zxc Jan 8, 2016 5:10:52 PM
 */
public class TailerHelper {
    ...
    /**
     * Creates a Tailer for the given file, starting from the beginning, with the default delay of 100ms.
     * 
    ...
    /**
     * Creates a Tailer for the given file, starting from the target position, with the default delay of 100ms.
     * 
     * @param file The file to follow
     * @param listener the TailerListener to use
